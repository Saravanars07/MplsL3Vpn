...
The MPLS provider core consists of:
 - P Routers
 - PE Routers
...
## PUSH
 Ingress PE pushes MPLS labels onto packets.

## SWAP
 P routers swap incoming labels with outgoing labels.

## POP
 Penultimate router removes transport label before forwarding to egress PE.
